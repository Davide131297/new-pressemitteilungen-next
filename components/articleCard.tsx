    ...
    <>
      {selectedNews.map((item) => (
        <Link
          ...
          className="block"
        >
          <article className="cursor-pointer bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl transition-shadow relative flex flex-col justify-between h-full">
            <div>
