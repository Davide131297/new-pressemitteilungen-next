          ...
          <Dialog>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Möchten Sie diesen Artikel oder Herausgeber melden? Diese
                  Aktion wird zur Überprüfung an die Administratoren
                  weitergeleitet.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
                <Button variant="outline">Abbrechen</Button>
                <Button variant="destructive" onClick={alertArticle}>
                  Melden
                </Button>
              </DialogFooter>
            </DialogContent>
...
export default function ArticleCart({ selectedNews }: ArticleCartProps) {
  ...
  return (
    <>
      {sortedNews.map((item) => (
        <ArticleCardItem key={item.url || item.link} item={item} />
      ))}
    </>
  );
}
